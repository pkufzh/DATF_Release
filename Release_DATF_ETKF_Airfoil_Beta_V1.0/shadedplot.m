...
% hold on % !!! 注意图层覆盖 !!!
% plot the line edges
hb=plot(x,y1,'b-','LineWidth',1);
hc=plot(x,y2,'r-','LineWidth',1);
...
set(ha(1),'HandleVisibility','off');
set(ha,'LineStyle','none');
% legend('计算上区间包络线','计算下区间包络线','计算下区间包络线','计算下区间包络线');
% hb=plot(x,y1,'bo','MarkerSize',4.0);
% hc=plot(x,y2,'ro','MarkerSize',4.0);
% hold off
